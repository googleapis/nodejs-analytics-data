...
describe('v1alpha.AlphaAnalyticsDataClient', () => {
    ...
    describe('runFunnelReport', () => {
        it('invokes runFunnelReport without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.analytics.data.v1alpha.RunFunnelReportRequest());
            request.property = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1alpha.RunFunnelReportResponse());
            ...
            assert((client.innerApiCalls.runFunnelReport as SinonStub)

...
describe('v1alpha.AlphaAnalyticsDataClient', () => {
    ...
    describe('runReport', () => {
        it('invokes runReport without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1alpha.RunReportResponse());
    ...
    describe('runPivotReport', () => {
        it('invokes runPivotReport without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1alpha.RunPivotReportResponse());
        ...
        it('invokes runPivotReport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runPivotReport(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.data.v1alpha.IRunPivotReportResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchRunReports', () => {
        it('invokes batchRunReports without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1alpha.BatchRunReportsResponse());
        ...
        it('invokes batchRunReports without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchRunReports(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.data.v1alpha.IBatchRunReportsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('batchRunPivotReports', () => {
        it('invokes batchRunPivotReports without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1alpha.BatchRunPivotReportsResponse());
        ...
        it('invokes batchRunPivotReports without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.batchRunPivotReports(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.data.v1alpha.IBatchRunPivotReportsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getMetadata', () => {
        it('invokes getMetadata without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1alpha.Metadata());
    ...
    describe('runRealtimeReport', () => {
        it('invokes runRealtimeReport without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1alpha.RunRealtimeReportResponse());
        ...
        it('invokes runRealtimeReport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runRealtimeReport(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.data.v1alpha.IRunRealtimeReportResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);

...
describe('v1beta.BetaAnalyticsDataClient', () => {
    ...
    describe('runPivotReport', () => {
        it('invokes runPivotReport without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1beta.RunPivotReportResponse());
            ...
            assert((client.innerApiCalls.runPivotReport as SinonStub)
    ...
    describe('batchRunReports', () => {
        it('invokes batchRunReports without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1beta.BatchRunReportsResponse());
            client.innerApiCalls.batchRunReports = stubSimpleCall(expectedResponse);
            const [response] = await client.batchRunReports(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.batchRunReports as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('batchRunPivotReports', () => {
        it('invokes batchRunPivotReports without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1beta.BatchRunPivotReportsResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.batchRunPivotReports as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getMetadata', () => {
        it('invokes getMetadata without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1beta.Metadata());
            client.innerApiCalls.getMetadata = stubSimpleCall(expectedResponse);
            const [response] = await client.getMetadata(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getMetadata as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('runRealtimeReport', () => {
        it('invokes runRealtimeReport without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1beta.RunRealtimeReportResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runRealtimeReport as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('runReport', () => {
        it('invokes runReport without error', async () => {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.data.v1beta.DimensionHeader()),
              generateSampleMessage(new protos.google.analytics.data.v1beta.DimensionHeader()),
              generateSampleMessage(new protos.google.analytics.data.v1beta.DimensionHeader()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.runReport as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes runReport without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.runReport(
                    request,
                    (err?: Error|null, result?: protos.google.analytics.data.v1beta.IDimensionHeader[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes runReportStream without error', async () => {
            ...
            client.descriptors.page.runReport.createStream = stubPageStreamingCall(expectedResponse);
            const stream = client.runReportStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.data.v1beta.DimensionHeader[] = [];
                stream.on('data', (response: protos.google.analytics.data.v1beta.DimensionHeader) => {
            ...
            assert((client.descriptors.page.runReport.createStream as SinonStub)
                .getCall(0).calledWith(client.innerApiCalls.runReport, request));
            assert.strictEqual(
        ...
        it('invokes runReportStream with error', async () => {
            ...
            const expectedHeaderRequestParams = "property=";
            const expectedError = new Error('expected');
            client.descriptors.page.runReport.createStream = stubPageStreamingCall(undefined, expectedError);
            const stream = client.runReportStream(request);
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.analytics.data.v1beta.DimensionHeader[] = [];
                stream.on('data', (response: protos.google.analytics.data.v1beta.DimensionHeader) => {
        ...
        it('uses async iteration with runReport without error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.analytics.data.v1beta.RunReportRequest());
            request.property = '';
            const expectedHeaderRequestParams = "property=";const expectedResponse = [
              generateSampleMessage(new protos.google.analytics.data.v1beta.DimensionHeader()),
              generateSampleMessage(new protos.google.analytics.data.v1beta.DimensionHeader()),
              generateSampleMessage(new protos.google.analytics.data.v1beta.DimensionHeader()),
            ];
            client.descriptors.page.runReport.asyncIterate = stubAsyncIterationCall(expectedResponse);
            ...
            assert.deepStrictEqual(
                (client.descriptors.page.runReport.asyncIterate as SinonStub)
        ...
        it('uses async iteration with runReport with error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.analytics.data.v1beta.RunReportRequest());
            request.property = '';
            const expectedHeaderRequestParams = "property=";const expectedError = new Error('expected');
            client.descriptors.page.runReport.asyncIterate = stubAsyncIterationCall(undefined, expectedError);
            const iterable = client.runReportAsync(request);

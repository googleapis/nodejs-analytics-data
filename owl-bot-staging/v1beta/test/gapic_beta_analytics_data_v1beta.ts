...
describe('v1beta.BetaAnalyticsDataClient', () => {
    ...
    describe('runReport', () => {
        it('invokes runReport without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1beta.RunReportResponse());
    ...
    describe('checkCompatibility', () => {
        it('invokes checkCompatibility without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.analytics.data.v1beta.CheckCompatibilityResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.checkCompatibility as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
